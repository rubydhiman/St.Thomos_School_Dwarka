          ...
          <div class='modal-dialog'> \
            <div class='modal-content'> \
              <div class='modal-header'> \
                <h2 class='modal-title'>St. Thomas School</h2> \
                <button type='button' class='close' data-dismiss='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button> \
              </div> \
              <div class='modal-body'> \
                <div id='calendarContainer' class='modalAlertCalendarContent'> \
                <div class='monthNavContainer'> \
                    <a class='monthNav' id='previousMonth' href='#'><i class='fa fa-arrow-circle-left'></i></a> \
                    <a class='monthNav' id='nextMonth' href='#'><i class='fa fa-arrow-circle-right'></i></a> \
                </div> \
